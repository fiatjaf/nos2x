(() => {
  ...
  document.getElementById("privateKeyInput").addEventListener("input", async (ev) => {
    try {
  ...
  import_webextension_polyfill.default.storage.local.get("private_key").then((results) => {
